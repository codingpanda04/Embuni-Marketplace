...
const SideBar = () => {
    ...
    const sideBarLinks = [
        {name: "Dashboard", path: "/sell", icon: assets.dashboardIcon},
        {name: "Add Product", path: "/sell/add-product", icon: assets.addIcon},
        {name: "Add Rentals", path: "/sell/add-rental", icon: assets.rentalIcon},
        {name: "Manage Listings", path: "/sell/manage-products-and-rentals", icon: assets.listIcon},
        {name: "Profile", path: "/sell/profile", icon: assets.profileIcon},
    ]
